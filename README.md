...
| Applied ML research | In LAWT - Linear Algebra with Transformers research at UMBC, implemented the analysis workflow, replicated the transformer algorithm across 12+ datasets, improved accuracy 15%, and surfaced 3 repeatable model/data issues. |
| End-to-end analytics products | Built a customer recovery strategy model over 30,000 synthetic customers with 93.4% accuracy, 0.981 ROC-AUC, five action tiers, feature importance, and reviewer-facing next-action logic. |
...
| [Customer Recovery Strategy Model](https://github.com/NeelVadlamudi/customer-recovery-strategy-model) | Classifies customer recovery likelihood into reviewer-facing action tiers instead of static repayment rules. | Synthetic case: 30,000 customers, 93.4% accuracy, 0.981 ROC-AUC, five action tiers, feature importance, and policy-sensitive review flags. | Python, gradient boosting, Streamlit, SQL, product analytics |
...
- Portfolio: [neelvadlamudi.github.io/neelresume](https://neelvadlamudi.github.io/neelresume/)
